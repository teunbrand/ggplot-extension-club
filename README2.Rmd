...
"Unscheduled", "Hadley Wickham", NA, "Thoughts on the ggplot2 extension ecosystem",
"Unscheduled", "Joseph Larmarange", "{ggstats}", "gglikert() and geom_likert()",
"2024-09-10", "James Otto", "{ggdensity}", "IRL extension culture", 

"2024-09-10, 3pm eastern", "James Otto", "{ggdensity}", NA,
