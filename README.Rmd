...
tibble::tribble(~ date, ~ presenter, ~ package, ~`special topic`, #~link,
                ...
                "2024-12-10", "Richard Hanna", "{ggswim}", NA,
                "2024-11-13", "Cory Brunson", "{ordr}", NA,
"2024-10-24", "Hadley Wickham", "{ggplot2}", "[Thoughts on the ggplot2 extension ecosystem](https://www.youtube.com/watch?v=kjjcgdkowXs&feature=youtu.be)",
